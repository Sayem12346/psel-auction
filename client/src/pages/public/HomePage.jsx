      ...
      <div style={{ padding: '50px 24px', textAlign: 'center', background: 'linear-gradient(180deg, #0d0d1a 0%, #080812 100%)', borderBottom: '1px solid #1e1e3a', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative' }}>
          ...
          <div style={{ display: 'flex', gap: 12, justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link to="/live" style={{ background: 'linear-gradient(135deg, #ef4444, #dc2626)', color: '#fff', textDecoration: 'none', padding: '12px 28px', borderRadius: 10, fontSize: 14, fontWeight: 700, letterSpacing: 1 }}>WATCH LIVE AUCTION</Link>
