        ...
        <div style={{ background: 'linear-gradient(135deg, #0d0d1a, #1a0a2e)', border: '1px solid #8b5cf633', borderRadius: 20, padding: 28, marginBottom: 24, position: 'relative', overflow: 'hidden' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 20, flexWrap: 'wrap' }}>
            ...
            <div style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              ...
              <div style={{ background: '#8b5cf622', border: '1px solid #8b5cf644', borderRadius: 12, padding: '14px 20px', textAlign: 'center' }}>
                <div style={{ color: '#8b5cf6', fontSize: 22, fontWeight: 900, fontFamily: 'Orbitron' }}>{o.totalCoins?.toLocaleString()}</div>
